# Stock Analysis
This project contains the stock analysis Excel workbook that Steve requested. It contains various VBA functions that is capable of processing daily stock results and combining them into a summarized analysis by year. Screenshots are also included to show refactored code performance.
